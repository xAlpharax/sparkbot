...
async def send_long_message(channel, text, ephemeral=False, interaction=None):
    """
    Sends long messages in chunks, preserving code blocks, markdown, syntax highlighting, and preventing whitespace artifacts.
    ...
    for chunk in split_message(text):
        if interaction is not None:
            # Correctly send follow-up messages as ephemeral
